...
public class RenameRefactoringAction extends AbstractPerspectiveAction implements ActivePartChangedHandler {
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        dialogFactory.createConfirmDialog(locale.renameUnsavedDataDialogTitle(),
                                          locale.renameUnsavedDataDialogPromptSaveChanges(),
    ...
    private void performAction() {
        if (editorInFocus) {
            Log.error(getClass(), "7777 editorInFocus");
            ...
            Log.error(getClass(), "7777 editor NOT in Focus");
